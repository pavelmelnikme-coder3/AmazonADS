...
const wawiRoutes = require("./routes/wawi");
...
const productAdsRoutes = require("./routes/productAds");
const keywordRanksRoutes  = require("./routes/keywordRanks");
const rankPortfoliosRoutes = require("./routes/rankPortfolios");
...
app.use(`${API}/rank-portfolios`, rankPortfoliosRoutes);
